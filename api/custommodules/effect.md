...
| Value                                       | Description                                                                                                                                                                                                                                                                 |
| ------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `EffectName`                                | The internal name of the status effect to be applied. Use a valid [`Effects`](../enums/external/effects.md) enum value such as `Scp207`, `Scp185`, `Scp268`, or `Poisoned`.                                                                                                 |
...
| [`Trigger`](../enums/internal/triggeron.md) | An enum value specifying when the effect should be applied. Possible values include: `OnShot` (when the player shoots a weapon), `OnUse` (when the player uses the item), `OnChangedItem` (when the player equips the item), `OnAdded` (when the player picks up the item). |
