...
| [`Trigger`](../enums/internal/triggeron.md) | The game event(s) that will trigger the Hume Shield modifications. Valid options include `OnAdded`, `OnChangedItem`, `OnUsedItem`. |
