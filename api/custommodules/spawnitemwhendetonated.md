...
| `ItemId`          | The ID of the item to spawn. This corresponds to the Custom Item ID for "uci" or "exi", or the [`ItemType`](../enums/external/itemtype.md) enum value for "normal". |
