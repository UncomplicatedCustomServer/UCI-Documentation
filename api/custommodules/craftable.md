...
| Value          | Description                                                                                                                                                                                                                                   |
| -------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `KnobSetting`  | Specifies the required SCP-914 knob setting (e.g., `1To1`, `Fine`, `Coarse`, `VeryFine`, `Rough`, `VeryRough`) for the crafting process. The value must be a valid [`Scp914KnobSetting`](../enums/external/scp914knobsetting.md) enum member. |
| `OriginalItem` | Defines the type of item (e.g., `Medkit`, `KeycardScientist`) that needs to be put into SCP-914 to craft this custom item. The value must be a valid [`ItemType`](../enums/external/itemtype.md) enum member.                                 |
