...
* `item_type` — [`ItemType`](../../../api/enums/external/itemtype.md) — Built-in item type to spawn if `is_custom_item` is `false`. (Use your project’s `ItemType` enum; no default provided in class.)
